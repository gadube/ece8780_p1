...
g = sns.catplot(x="Input Image",y="Size (B)",kind="bar",hue="Name",aspect=1.3,ci=None,data=transfers)
...
g = sns.catplot(x="Input Image",y="Throughput (GB/s)",row="Device Name",kind="bar",hue="Name",aspect=1.3,ci=None,data=transfers)
g.set_xticklabels(["Baboon\n(512x512)","Dog\n(1600x1200)","Lemons\n(3456x2304)","Lena\n(400x225)","Peppers\n(506x326)"])
#g.set_xticklabels(["Baboon\n(512x512)","Dog\n(1600x1200)","Lena\n(400x225)","Peppers\n(506x326)"])
axes = g.axes.flatten()
...
g = sns.catplot(x="Input Image",y="Duration",row="Device Name",kind="bar",hue="Name",aspect=1.3,ci=None,data=transfers)
g.set_xticklabels(["Baboon\n(512x512)","Dog\n(1600x1200)","Lemons\n(3456x2304)","Lena\n(400x225)","Peppers\n(506x326)"])
#g.set_xticklabels(["Baboon\n(512x512)","Dog\n(1600x1200)","Lena\n(400x225)","Peppers\n(506x326)"])
g.set(yscale="log")
axes = g.axes.flatten()
...
hue_order = ["['4', '4', '1']","['8', '8', '1']","['16', '16', '1']","['32', '32', '1']"]
g = sns.catplot(x="Input Image",y="Duration",row="Device Name",kind="bar",hue="Block Size",hue_order=hue_order,aspect=1.3,ci=None,data=kernel)
g.set_xticklabels(["Baboon\n(512x512)","Dog\n(1600x1200)","Lemons\n(3456x2304)","Lena\n(400x225)","Peppers\n(506x326)"])
#g.set_xticklabels(["Baboon\n(512x512)","Dog\n(1600x1200)","Lena\n(400x225)","Peppers\n(506x326)"])
g.set(yscale="log")
axes = g.axes.flatten()
